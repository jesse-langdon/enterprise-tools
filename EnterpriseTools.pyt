# -*- coding: utf-8 -*-
# Toolbox Name:     EnterpriseTools.pyt
# Description:      Enterprise Tools is a Python toolbox written for ArcGIS Pro, which includes custom tools that can
#                   perform basic data management tasks with ESRI geodatabases and APRX files.
...
class Toolbox(object):
    def __init__(self):
        ...
        self.label = "Enterprise Tools"
        self.alias = ""

        # List of tool classes associated with this toolbox
        self.tools = [APRXInventoryTool, GDBInventoryTool, GetDomainsTool, CleanGeodatabaseTool, SyncMetadataTool, UpdateAPRXSources]
